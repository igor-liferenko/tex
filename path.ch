...
@y
@d format_default_length	37 /*length of the |TEX_format_default| string*/
...
@y
ASCII_code @!TEX_format_default[1+format_default_length+1]=" /home/user/ctex/TeXformats/virtex.fmt";
@z
