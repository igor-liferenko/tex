...
\medskip
Let's make |char| and |text_char| the same type by analogy with |tex.web| (see \S19 in [3]).
\verbatim
< char TEX_format_d...=" TeXformats/plai...
> wchar_t TEX_forma...=L" TeXformats/pla...

< char months[]=" JANFEBMARAPRMAYJUNJULA...
...
Strings passed to the macro {\it write\/}
can be specified directly in \UTF-8.
And as they are in ASCII (which is a subset of
\UTF-8), we don't need to touch them.
