...
\endverbatim
One exception to this rule is stated in \S26
(in comment to {\it name\_of\_file\/}).
This exception is useful in the present implementation,
as file names are in \UTF-8 (on most systems).
Thus, we use |char| instead of |wchar_t|.
\verbatim
